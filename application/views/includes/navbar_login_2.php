<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="<?php echo base_url(); ?>index.php/home">ABCD</a>
            <div class="nav-collapse collapse">
                <ul class="nav">
                    <li class="active"><a href="<?php echo base_url(); ?>index.php/home"><i class="icon-home icon-white"></i>Home</a></li>
                    <li><a href="<?php echo base_url(); ?>index.php/registration/#"><i class="icon-user icon-white"></i>Add Review</a></li>
                </ul>
